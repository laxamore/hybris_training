 ...
 */
package org.training.trainingextensioncommercewebservices.xstream;
...
public class XmlXStreamMarshallerFactoryTest
{
	...
	private static final String SERVICE_BEAN_DEF = "" + "<beans xmlns=\"http://www.springframework.org/schema/beans\"\n"//
			...
			+ "       <bean\n"//
			+ "             id=\"onlyOneInstance\"\n"//
			+ "             class=\"org.training.trainingextensioncommercewebservices.xstream.XmlXStreamMarshallerFactory\">\n"//
			+ "       </bean>\n"//
			+ "</beans>";
